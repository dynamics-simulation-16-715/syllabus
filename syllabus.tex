...
\begin{enumerate}
	\item Model industrial, wheeled, legged, aerial, underwater, and space robotic systems
	\item Build simulators for complex robotic systems that interact with their environments
	\item TODO: add some more
...
\begin{tabular}{c|c|c|c}
	...
	\hline
	\multirow{2}{*}{1} & Aug 31 & Course Overview \\
	 & Sep 2 & ToDo &  \\
	\hline
	\multirow{2}{*}{2} & Sep 7 & ToDo & HW 1 Out \\
	 & Sep 9 & ToDo &  \\
	\hline
	\multirow{2}{*}{3}  & Sep 14 & ToDo &  \\
	 & Sep 16 & ToDo \& LQR &  \\
	\hline
	\multirow{2}{*}{4}  & Sep 21 & ToDo & HW 1 Due \\
	 & Sep 23 & ToDo & HW 2 Out \\
	\hline
	\multirow{2}{*}{5}  & Sep 28 & ToDo & \\
	 & Sep 30 & ToDo &  \\
	\hline
	\multirow{2}{*}{6}  & Oct 5 & ToDo &   HW2 Due \\
	 & Oct 7 & ToDo & HW3 Out \\
	\hline
	\multirow{2}{*}{7}  & Oct 12 &  ToDo  & \\
	 & Oct 14 & \textcolor{red}{No Class} & \\
	\hline
	\multirow{2}{*}{8}  & Oct 19 & ToDo & \\
	 & Oct 21 & ToDo & \\
	\hline
	\multirow{2}{*}{9}  & Oct 26 & HToDo & HW3 Due \\
	 & Oct 28 & ToDo &   \\
	\hline
	\multirow{2}{*}{10}  & Nov 2 & ToDo &  HW4 Out \\
	 & Nov 4 & ToDo \& LQG & \\
	 \hline
	\multirow{2}{*}{11}  & Nov 9 & ToDo \& Minimax DDP &  \\
	 & Nov 11 & \textcolor{red}{No Class} &   \\
	 \hline
	\multirow{2}{*}{12}  & Nov 16 & ToDo &  HW4 Due \\
	 & Nov 18 & ToDo \& JPL &   \\
	 \hline
	\multirow{2}{*}{13}  & Nov 23 & ToDo &  \\
